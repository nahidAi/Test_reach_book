...
public class FragNav extends Fragment {
    ...
    private List<InfoNav> postdata() {
        ...
        String title[] = {"جستجو", "علاقه مندی ها", "تنظیمات", "منابع", "خروج"};
        int iconid[] = {R.drawable.ic_magnify_black_48dp, R.drawable.ic_favorite, R.drawable.ic_settings_black_48dp, R.drawable.ic_web_black_48dp, R.drawable.ic_exit_to_app_black_48dp};
